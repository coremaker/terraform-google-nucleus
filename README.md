...
| <a name="input_billing_disable_default_iam_recipients"></a> [billing\_disable\_default\_iam\_recipients](#input\_billing\_disable\_default\_iam\_recipients) | Default recipients are those with Billing Account Administrators and Billing Account Users IAM roles for the target account. | `bool` | `false` | no |
